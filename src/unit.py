...
std_units = {
    ...
    "DUSTAMPLITUDE": Unit("MJy"),
    "DUSTSCALEFREQUENCY": Unit("GHz"),
    "SYNCHROTRONSPECINDEX": Unit("NA"),
    "SYNCHROTRONAMPLITUDE": Unit("K"),
    "SYNCSCALEFREQUENCY": Unit("GHz"),
    "ELEVATION": Unit("deg"),
    "PWV": Unit("mm"),
    "OBSERVATIONTIME": Unit("yr"),
    "SKYFRACTION": Unit("NA"),
    "OBSERVATIONEFFICIENCY": Unit("NA"),
    "NETMARGIN": Unit("NA"),
    "BORESIGHTELEVATION": Unit("deg"),
    "OPTICALCOUPLING": Unit("NA"),
    "FNUMBER": Unit("NA"),
    "BATHTEMP": Unit("K"),
    "BANDCENTER": Unit("GHz"),
    "FRACTIONALBW": Unit("NA"),
    "PIXELSIZE": Unit("mm"),
    "NUMDETPERWAF": Unit("NA"),
    "NUMWAFPEROT": Unit("NA"),
    "NUMOT": Unit("NA"),
    "WAISTFACTOR": Unit("NA"),
    "DETEFF": Unit("NA"),
    "PSAT": Unit("pW"),
    "PSATFACTOR": Unit("NA"),
    "CARRIERINDEX": Unit("NA"),
    "TC": Unit("K"),
    "TCFRACTION": Unit("NA"),
    "FLINK": Unit("NA"),
    "G": Unit("pW"),
    "YIELD": Unit("NA"),
    "SQUIDNEI": Unit("pA/rtHz"),
    "BOLORESISTANCE": Unit("Ohm"),
    "READNOISEFRAC": Unit("NA"),
    "TEMPERATURE": Unit("K"),
    "ABSORPTION": Unit("NA"),
    "REFLECTION": Unit("NA"),
    "THICKNESS": Unit("mm"),
    "INDEX": Unit("NA"),
    "LOSSTANGENT": Unit("e-4"),
    "CONDUCTIVITY": Unit("e+6"),
    "SURFACEROUGH": Unit("um RMS"),
    "SPILLOVER": Unit("NA"),
    "SPILLOVERTEMP": Unit("K"),
    "SCATTERFRAC": Unit("NA"),
    "SCATTERTEMP": Unit("K"),
    "POPT": Unit("pW"),
    "NEP": Unit("aW/rtHz"),
